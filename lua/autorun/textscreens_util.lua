TextScreenModify = TextScreenModify or {}
TextScreenModify.Config = TextScreenModify.Config or {}
...
if SERVER then
	util.AddNetworkString("TextScreenModify_Notify")

	function TextScreenModify:Notify(ply, enum, time, text)

		net.Start("TextScreenModify_Notify")
...
elseif CLIENT then
	net.Receive("TextScreenModify_Notify", function()
