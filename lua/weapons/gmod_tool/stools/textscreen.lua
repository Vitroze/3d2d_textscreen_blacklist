...
function TOOL:LeftClick(tr)
	...
	for i = 1, 5 do
		...
		if text ~= "" then
			if table.HasValue(TextScreenModify.Config.BlackListWord, text) then return TextScreenModify:Notify(ply, 1, 3, "Impossible to make your text appear. A word you put in has been blacklisted!") end
			hasText = true
		end
	end
